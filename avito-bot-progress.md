...
- [ ] 1.0.1 Создать /opt/mn/ и поддиректории
- [ ] 1.0.2 Создать Linux-пользователей mn-avito, mn-crm
- [ ] 1.0.3 Настроить права (chmod 700, shared 755)
- [ ] 1.0.4 Скопировать 10 JSON-конфигов в shared/config/
- [ ] 1.0.5 Инициализировать venv для avito-bot
